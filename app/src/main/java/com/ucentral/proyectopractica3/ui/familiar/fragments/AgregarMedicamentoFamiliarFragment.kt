...
class AgregarMedicamentoFamiliarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // ----- Paciente actual -----
        val tvPacienteActual = view.findViewById<TextView>(R.id.tvPacienteActualMedicamentoFamiliar)
        val nombrePaciente = PacienteSeleccionado.pacienteNombre
        if (PacienteSeleccionado.pacienteId == null || nombrePaciente.isNullOrBlank()) {
            tvPacienteActual.text = "Paciente actual: Ninguno seleccionado"
        } else {
            tvPacienteActual.text = "Paciente actual: $nombrePaciente"
        }
        ...
        btnGuardar.setOnClickListener {
            ...
            if (pacienteId == null) {
                Toast.makeText(
                    requireContext(),
                    "Selecciona primero un paciente en 'Pacientes asociados'",
                    Toast.LENGTH_SHORT
                ).show()
            ...
            if (!cbManana.isChecked && !cbMediodia.isChecked &&
                ...
                Toast.makeText(
                    requireContext(),
                    "Selecciona al menos un ciclo (mañana, mediodía, tarde o noche)",
                    Toast.LENGTH_SHORT
                ).show()
                return@setOnClickListener
            }
